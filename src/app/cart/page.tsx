...
export default function CartPage() {
  ...
  try {
    ...
    if (!response.ok) {
      ...
      alert(data.error || "حدث خطأ أثناء تحديث الكمية");
      return;
    }
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <span className="font-black text-[#174c32]">سوف يتم خصم الشحن اذا كنت من سكان قريه عرب الرمل او اجهور الرمل</span>
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-[11px] leading-5 text-[#8b7650]">
                            ...
                            <span className="font-black">
                              {(5000 - subtotal).toLocaleString("ar-EG")} جنيه
                            </span>{" "}
                            لتحصل على شحن مجاني.
                          </p>
